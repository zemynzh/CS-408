            ...
            <div className="relative glass-liquid bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-3xl p-8 lg:p-12 border border-white/20 dark:border-gray-700/20 shadow-2xl shadow-black/10 dark:shadow-black/30">
              <div className="text-center max-w-4xl mx-auto">
                ...
                <p className="text-lg lg:text-xl text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                  计算机科学的核心基础，掌握数据组织与算法设计的精髓
                </p>
                <div className="flex flex-wrap justify-center gap-4">
                  <div className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
                    <Clock className="w-4 h-4" />
                    <span>预计学习时间: 80小时</span>
                  </div>
                  <div className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    数据结构是计算机科学的基础课程，研究数据的逻辑结构、存储结构以及在其上的基本操作。
                    本课程将系统性地学习线性结构、树形结构、图结构以及查找排序算法。
                  </p>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    通过理论学习和实践操作，掌握各种数据结构的实现原理、性能分析和应用场景，
                    为后续的算法设计和系统开发奠定坚实基础。
                  </p>
                </div>
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-800 dark:text-white">理论结合实践</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">深入理解数据结构原理，配合可视化演示</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">动态演示算法执行过程，直观理解原理</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-800 dark:text-white">互动式学习</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">通过练习和测试巩固知识点掌握</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="glass-liquid bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-3xl p-8 border border-white/20 dark:border-gray-700/20 shadow-xl shadow-black/10 dark:shadow-black/30">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="glass-liquid bg-blue-50/50 dark:bg-blue-900/20 rounded-2xl p-6 border border-blue-200/30 dark:border-blue-700/30">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">理解数据结构原理</h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    深入理解各种数据结构的逻辑结构、存储结构和基本操作原理
                  </p>
                </div>
                ...
                <div className="glass-liquid bg-green-50/50 dark:bg-green-900/20 rounded-2xl p-6 border border-green-200/30 dark:border-green-700/30">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">掌握算法设计</h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    学会分析算法复杂度，掌握常用算法的设计思想和实现方法
                  </p>
                </div>
