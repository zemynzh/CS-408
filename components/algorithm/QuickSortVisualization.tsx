...
interface ArrayElement {
  value: number
  status: 'normal' | 'comparing' | 'pivot' | 'partitioning' | 'sorted'
}
...
export default function QuickSortVisualization() {
  ...
  // 快速排序算法
  const quickSort = async (arr: ArrayElement[], low: number, high: number) => {
    if (low < high) {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <div className="space-y-4 text-gray-600 dark:text-gray-400">
                    <p className="leading-relaxed">
                      快速排序是一种高效的排序算法，使用分治策略。它选择一个基准元素，
                      将数组分为两部分，左边都小于基准，右边都大于基准，然后递归排序。
                    </p>
                    <p className="leading-relaxed">
                      就像在图书馆整理书籍，我们选择一个分类标准（比如作者姓氏），
                      将所有书籍分成"小于这个标准"和"大于这个标准"两堆，然后对每堆重复这个过程。
                    </p>
                    <p>
                      <strong>特点：</strong>
                    </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <ol className="list-decimal list-inside space-y-2 ml-4 text-gray-600 dark:text-gray-400">
                      <li>选择一个基准元素（通常选择最后一个元素）</li>
                      <li>将小于基准的元素放在左边，大于基准的元素放在右边</li>
                      <li>基准元素现在在正确的位置</li>
                      <li>递归地对左右两部分进行排序</li>
                      <li>重复直到所有元素都排序完成</li>
                    </ol>
                    ...
                    <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200/30 dark:border-blue-700/30">
                      <p className="text-sm text-blue-800 dark:text-blue-300">
                        <strong>优化提示：</strong>快速排序的平均性能很好，但基准选择很重要。
                        对于已经排序的数据，选择中间元素作为基准可以避免最坏情况。
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="glass-liquid bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-3xl p-6 border border-white/20 dark:border-gray-700/20 shadow-xl shadow-black/10 dark:shadow-black/30">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-gray-600 dark:text-gray-400">基准元素</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-4 h-4 rounded bg-orange-400 dark:bg-orange-500 shadow-lg shadow-orange-500/50"></div>
                  <span className="text-sm text-gray-600 dark:text-gray-400">正在分区的元素</span>
                </div>
                <div className="flex items-center space-x-3">
