...
interface GraphNode {
  ...
  x: number
  y: number
  status: 'unvisited' | 'visited' | 'current' | 'path' | 'target'
  neighbors: number[]
}
...
export default function DepthFirstSearchVisualization() {
  ...
  // 深度优先搜索算法
  const depthFirstSearch = useCallback(async () => {
          ...
          <div className="lg:col-span-2">
            <div className="glass-liquid bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-3xl p-8 border border-white/20 dark:border-gray-700/20 shadow-xl shadow-black/10 dark:shadow-black/30">
              ...
              <div className="flex items-center justify-center space-x-4">
                <button
                  onClick={isRunning ? togglePause : depthFirstSearch}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <div className="space-y-4 text-gray-600 dark:text-gray-400">
                    <p className="leading-relaxed">
                      深度优先搜索(DFS)是一种图遍历算法，它沿着图的深度方向进行搜索，
                      尽可能深地探索图的分支，直到达到目标节点或无法继续前进。
                    </p>
                    <p className="leading-relaxed">
                      就像走迷宫一样，DFS会选择一条路径一直走下去，直到遇到死胡同，
                      然后回溯到上一个分叉点，选择另一条路径继续探索。
                    </p>
                    <p>
                      <strong>特点：</strong>
                    </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <ol className="list-decimal list-inside space-y-2 ml-4 text-gray-600 dark:text-gray-400">
                      ...
                      <li>当栈不为空时，弹出栈顶节点</li>
                      <li>检查当前节点是否为目标节点</li>
                      <li>将当前节点的所有未访问邻居加入栈中</li>
                      <li>重复步骤3-5直到找到目标或栈为空</li>
                    </ol>
                    ...
                    <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200/30 dark:border-blue-700/30">
                      <p className="text-sm text-blue-800 dark:text-blue-300">
                        <strong>应用场景：</strong>深度优先搜索常用于迷宫求解、拓扑排序、
                        连通分量查找、回溯算法等场景。
                      </p>
                    </div>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <div className="glass-liquid bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-3xl p-6 border border-white/20 dark:border-gray-700/20 shadow-xl shadow-black/10 dark:shadow-black/30">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600 dark:text-gray-400">栈大小</span>
                  <span className="text-sm font-semibold text-purple-600 dark:text-purple-400">{stack.length}</span>
                </div>
                <div className="flex justify-between items-center">
